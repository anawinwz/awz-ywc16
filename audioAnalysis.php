...
if(empty($trackId) || !@preg_match("/^[0-9a-zA-Z]+$/",$trackId) || !isset($headers['Authorization'])) {
...
curl_setopt($process, CURLOPT_HTTPHEADER, array("Authorization: ".$headers["Authorization"]));
